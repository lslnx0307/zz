...
insert  into `t_sys_resource`(`id`,`resource_name`,`resource_url`,`add_time`,`update_time`,`del_flag`) values (1,'文章管理','/a/b.do','2020-05-31 22:27:19','2020-05-31 22:27:21',0),(2,'菜单列表','/menu/list',NULL,NULL,0),(3,'菜单新增','/menu/add',NULL,NULL,0),(4,'角色新增','/role/add',NULL,NULL,0),(5,'角色列表','/role/list',NULL,NULL,0),(6,'用户列表','/user/list',NULL,NULL,0),(7,'用户新增','/user/add',NULL,NULL,0);
...
insert  into `t_sys_role`(`id`,`role_name`,`add_time`,`update_time`,`del_flag`) values (1,'admin','2020-05-31 22:27:55','2020-05-31 22:27:58',0),(2,'老板','2020-05-31 22:30:15','2020-05-31 22:30:18',0),(3,'测试',NULL,NULL,NULL),(4,'客服','2020-06-05 14:33:47','2020-06-05 14:33:47',0);
...
CREATE TABLE `t_sys_user` (
  ...
  `lock` smallint(1) NOT NULL DEFAULT '0' COMMENT '是否锁定',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;

/*Data for the table `t_sys_user` */

insert  into `t_sys_user`(`id`,`login_account`,`real_name`,`login_pwd`,`last_login`,`lock`) values (1,'lishiliang','李世梁','$2a$10$lvsMGTI2r7m7E5BFnAGCXe2KgK4bpKZtAmfjiKW/Z9JRnEzBjBM7u','2020-05-31 22:26:33',0);
...
insert  into `t_sys_user_role`(`id`,`user_id`,`role_id`,`add_time`,`update_time`,`del_flag`) values (1,1,1,'2020-05-31 22:29:53','2020-05-31 22:29:55',0),(2,1,2,'2020-05-31 22:30:30','2020-05-31 22:30:33',0);
